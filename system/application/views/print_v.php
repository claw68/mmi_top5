<p style = "font-size:1.4em; font-weight: bold;">Judge: <?php echo $judgeInfo->judge_name?> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; Event: <?php echo $eventInfo->event_name?></p> 
        <div style = "font-size:1.5em; font-family: Arial"><table id="grid_male" class="scroll" cellpadding="0" cellspacing="0" style="cursor: pointer; -moz-user-select: none;"></table></div>
        <div class="clearer">&nbsp;</div> 
        <div style = "font-size:1.5em; font-family: Arial; margin-top: -100px;"><table id="grid_female" class="scroll" cellpadding="0" cellspacing="0" style="cursor: pointer; -moz-user-select: none;"></table></div>
    <script type="text/javascript">
    
    $("#grid_male").jqGrid({
            
            // url:'http://localhost/MMI/?mmi_c/function_grid',
            url:'?mmi_top5_c/admin_grid_data_m',
            datatype: "json",
    ...
    $("#grid_female").jqGrid({
            scrollrows: true,
            url:'?mmi_top5_c/admin_grid_data_f',
            datatype: "json",
     ...
     <div class="clearer">&nbsp;</div>
      <div class="clearer">&nbsp;</div>
       <div class="clearer">&nbsp;</div>
    <div style = "font-size:1.5em; font-weight: bold;  margin-top: -75px;">Certified True and Correct:</div>
        <div class="clearer">&nbsp;</div>
