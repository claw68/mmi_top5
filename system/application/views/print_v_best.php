<p style = "font-size:1.4em; font-weight: bold;"><?php echo $eventInfo->event_name?> Final Ranks</p> 
        ...
        <div style = "font-size:1.5em; font-family: Arial"><table id="grid_female" class="scroll" cellpadding="0" cellspacing="0" style="cursor: pointer; -moz-user-select: none;"></table></div>
    <script type="text/javascript">
    
    $("#grid_male").jqGrid({
            
            // url:'http://localhost/MMI/?mmi_c/function_grid',
            url:'?mmi_top5_c/best_grid_data_m',
            datatype: "json",
    ...
    $("#grid_female").jqGrid({
            scrollrows: true,
            url:'?mmi_top5_c/best_grid_data_f',
            datatype: "json",
            colNames:['Candidate Number',<?php foreach($judge as $row){ ?>'<?php echo $row->judge_name; ?>',<?php } ?>'Total','Rank'],
            colModel:[
                    {name:'num',index:'num',align:"center", sortable: true,sorttype:'int'},
