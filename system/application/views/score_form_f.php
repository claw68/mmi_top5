...
$("#conbtn_f").button().click(function () {  
      ...
      $.ajax({
      type: "POST",
      url: "mmi_top5_c/ajax_set_score_f",
      ...
      error: function()
      {
        $("#error").dialog('open');   
   	  ...
   	  <fieldset class="text ui-widget-content ui-corner-all" style="height: 940px; border: 1px solid #bbb;font-family:lucida calligraphy;">
        ...
        <img style="background-color:#fff" src="files/cont_pic/<?php echo $contInfo->cont_pic; ?>" />
           ...
           <tr>
            ...
            <td class="quantity">
              ...
              <input type="text" class="score_field_f" name="score_f[]" id="score_f<?php echo $i; ?>" <?php if($allScore_f){ ?> value="<?php $allScore_f[$i]->score; ?>" <?php }else { ?> value="0"<?php } ?> />
            </td> 
           </tr>  
            <?php } ?>
