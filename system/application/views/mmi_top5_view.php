...
<?php $this->load->view('user_buttons'); ?>   
</head>
...
<div class="entire">
 <div>
      <div style="position:absolute;width:200px;color:#fff;"><h1><?php echo $judge_name; ?></h1></div>
      <div style="float:right;width:100px;"> <a id="logout" href="mmi_top5_c/logout">Logout</a></div>                              
  </div>  
  <!-- HEADER SECTION -->
  <div class="header">
      ...
      <div class="sub_head">
          	<div id="cat_dis">"TOP 5"</div>
          	<div id="id_dis">Contestant #1</div>
	    </div>
  ...
  <div class="whole">	
  	...
  	<div class="centercol">
  	   ...
  	   <div style="margin-top:50px" id="cont_id<?php echo $i; ?>" class="num_pad">
