<?php
  class Mmi_top5_m extends Model {
        ...
        function getAllEvent()
    {
      ...
      return $query->result();
        ...
        function getContInfoAll($cont_gen)
    {
      $this->db->like('cont_id', $cont_gen, 'before');
      $this->db->order_by('cont_id');
    ...
    //////aaaaaaaaddddddddddd,mmmmmmmmmmmmmiiiiiiiiiiinnnnnnnnnnnnnnnnnnnnnnnnn
    //////ppppppprrrrrrrrrrroooooooooojjjjjjjjjjjjjjjjjjjjjjj
...
order by RAND()';
    ...
    /////////eeeeeeeeeennnnnnddddddddddddddddddd pppppppppproooooooooooooooooojjjjjjjj
